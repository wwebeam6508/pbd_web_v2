                    ...
                    <div className={`container-fluid`}>
                        <div className={`${contactStyles.contactZone} row`} >
                            ...
                            <div className={`col-md-6 text-center ${contactStyles.detail}`}>
                                ...
                                <h4 ><a rel="facebookprofile" href='https://www.facebook.com/PBD-Supply-105617124490051' target="_blank"><Image width={'100px'} height={'100px'} src='/facebook.png' /></a></h4>
                            </div>
                        </div>
                    </div>
                </div>
